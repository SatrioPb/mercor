                                    ...
                                    <div class="container col-xxl-12 px-4 py-4 pb-1" id="Introduction">
                                        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <td> <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="hapus_intro.php?id=<?php echo $data['id']; ?> " class="btn btn-danger">Hapus</a>
                                                    <a href="form_edit_intro.php?id=<?= $data['id']; ?>" class="btn btn-success">Edit</a>
                                            </div>
