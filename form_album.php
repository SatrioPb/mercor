                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <div class="body">
                                        ...
                                        <form action="input_album.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="date" name="date" class="form-control form-control-user" id="date" aria-describedby="emailHelp" required " />
							                 </div>
						                        </div>
